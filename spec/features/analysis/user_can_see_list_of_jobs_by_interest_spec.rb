...
describe 'User visits /dashboard' do
  scenario "user sees all the jobs sorted by level of interest" do
    ...
    job2 = company.jobs.create!(title: "QA Analyst", level_of_interest: 25, city: "New York City", category_id: category.id)
    job3 = company.jobs.create!(title: "Developer", level_of_interest: 25, city: "Chicago", category_id: category.id)
